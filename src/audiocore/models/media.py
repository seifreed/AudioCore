...
class MediaInfo(BaseModel):
    ...
    sample_rate: int | None = Field(default=None, gt=0, description="Audio sample rate in Hz")
    channels: int | None = Field(default=None, gt=0, description="Number of audio channels")
