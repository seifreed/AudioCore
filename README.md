...
[`sbom/audiocore.cdx.json`](sbom/audiocore.cdx.json), generated by a reproducible
[`generate_sbom.py`](sbom/generate_sbom.py) pipeline and graded with
...
Completeness, Identifiers, and Integrity score **100/100**, and the SBOM is
**NTIA-minimum-elements compliant**. CI (`.github/workflows/sbom.yml`) fails if
the rating drops below Grade A. See [`sbom/README.md`](sbom/README.md) for the
full breakdown and regeneration instructions (`make sbom`).
