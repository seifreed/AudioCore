...
[`sbom/audiocore.cdx.json`](sbom/audiocore.cdx.json), built by a reproducible
[`generate_sbom.py`](sbom/generate_sbom.py) pipeline and graded by two
independent scorers:

- **[sbomqs](https://github.com/interlynk-io/sbomqs): `10.0/10` = `100%`, Grade A**
  on the **NTIA Minimum Elements** standard (2021 and 2025).
- **[sbom-tools](https://github.com/sbom-tool/sbom-tools): Grade A** (92.6/100
  standard profile), with Completeness, Identifiers, Integrity, and Licenses at
  **100/100**.
...
Grade A, or sbomqs NTIA below 100/A). See [`sbom/README.md`](sbom/README.md) for
